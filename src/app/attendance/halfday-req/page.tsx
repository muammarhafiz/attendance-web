...
export default function HalfdayRequestsPage() {
  ...
  return (
    <div>
      ...
      {filtered.length === 0 ? (
        <div className="rounded-lg border border-line bg-ink/[0.03] p-6 text-center text-sm text-ink-2">No half-day requests.</div>
      ) : (
              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <div className="text-sm font-medium text-ink">
                    ...
                    <span className="ml-2 rounded-full bg-accent-weak px-2 py-0.5 text-xs font-medium text-accent">½ {halfLabel(r.half)}</span>
