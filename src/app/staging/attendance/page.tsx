              ...
              {today.map((r, i) => {
                ...
                return (
                  <tr key={r.staff_email + i} style={{ background: i % 2 ? '#fff' : '#fcfcfc' }}>
                    ...
                    <td style={{ padding: 8, borderBottom: '1px solid #f3f4f6', color: isLate ? '#b91c1c' : undefined, fontWeight: isLate ? 700 as any : 400 }}>
                      {r.check_in_kl ?? '—'}
                    </td>
                    <td style={{ padding: 8, borderBottom: '1px solid #f3f4f6' }}>
                      {r.check_out_kl ?? '—'}
                    </td>
                    <td style={{ padding: 8, borderBottom: '1px solid #f3f4f6', textAlign: 'right', color: isLate ? '#b91c1c' : undefined, fontWeight: isLate ? 700 as any : 400 }}>
                      {r.late_min ?? 0}
                    </td>
                  </tr>
                );
