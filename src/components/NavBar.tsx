    ...
    <nav className="no-print sticky top-0 z-40 w-full border-b border-gray-200 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <div className="flex items-center gap-1 sm:gap-2">
          <Link href="/" className="mr-2 hidden rounded-md px-2 py-1 text-sm font-bold tracking-wide text-gray-900 sm:inline-flex" aria-label="Home" title="Home">
            Attendance
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {email ? (
            <>
              ...
              <button onClick={handleSignOut} className="inline-flex items-center rounded-md bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-900 transition hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-300">
                Sign out
              </button>
            </>
          ) : (
            <Link href="/login" className="inline-flex items-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
              Sign in
            </Link>
          )}
        </div>
